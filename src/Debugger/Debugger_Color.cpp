...
// Color ______________________________________________________________________
	...
	int g_aColorPalette[ NUM_PALETTE ] =
	{
		...
		GREEN, GREEN, MONOCHROME_GREEN, MONOCHROME_GREEN, DARK_GREEN, DARK_GREEN, DARK_GREEN, DARK_GREEN,  // 010 // Green
		...
		CYAN, CYAN, CYAN, CYAN, DARK_CYAN, DARK_CYAN, DARKER_CYAN, DARKER_CYAN,  // 110 // Cyan
